...
'''This module reads from a gz file stored in data, containing information on Amazon Reviews'''
'''The module first reads the gz file and extracts a number of reviews - currently 1000'''
'''The module then reads and store the extracts in memory for use by the front end'''
